package dba.chestnutandhazel.SP; // package edu.unlv.mis768.kly.individualassignment3;
...
public class Package {
	...
	"In most cases, the program generates the correct result.
	I observed some issues:
	1. According to the rubric, the Package class should have methods determining whether the package is oversized or overweight.
	2. For the Shipment class, theTotalNumberOfPackages, theGrandTotal, thePreliminaryGrandTotal, and the billableWeight are results of calculation. Thus they should not be defined as fields of the class.
	3. According to the rubric, the Shipment class should include an ArrayList of Package objects and methods determining the two types of discounts.
	4. When the cost is greater than $300, the program does not apply the bulk discount when the user is not a frequent-shipper.
	
	
	Some suggestions:
	1. For the model class (e.g., Package and Shipment class), please avoid user interaction (i.e., getting user input). Please keep the user interaction at the main method.
	2. while(true) with break statement is not recommended. You can achieve the same result by using proper while statements.
	Han-Fen Hu , Apr 5 at 1:12am
	...
	(Han-fen Hu, Ph.D., personal communication, April 5th, 2019).
